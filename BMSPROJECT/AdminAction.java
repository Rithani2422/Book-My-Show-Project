...
public class AdminAction {
    ...
    public static void addTheatre(Scanner scanner) {
        ...
        // Process adding screens (no changes needed here)
    ...
    public static void addMovie(Scanner scanner) {
        ...
        // Add the movie to the movie directory
        BMS.getMovieDirectory()
                .computeIfAbsent(movieName, ignored -> new ArrayList<>())
                .add(new Movies(movieName, movieLocation, newShow.getShowDate(), selectedTheatre, selectedScreen, newShow));
    ...
    public static void viewAllMovies() {
        ...
        for (ArrayList<Movies> movieList : BMS.getMovieDirectory().values()) {
            for (Movies movie : movieList) {
                ...
                HashMap<Character, ArrayList<String>> seatArrangement = show.getSeatArrangement(); // Get seat arrangement

                System.out.println("\n========================================");
                System.out.println("Movie Name: " + movie.getName());

                // Corrected the order: Location should come after Theatre
                ...
                for (Map.Entry<Character, ArrayList<String>> entry : seatArrangement.entrySet()) {
                    System.out.print(entry.getKey() + ": "); // Row label (e.g., A, B, C)
                    for (String seat : entry.getValue()) {
                        System.out.print(seat + " "); // Add a space after each seat
                    }
